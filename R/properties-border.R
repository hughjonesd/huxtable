...
left_border_set_default <- xxx_border_arrow_yyy_hux(
  "lr_borders",
  quote(seq_len(nrow(ht))), quote(-last_col), "thickness"
)
left_border_set_brdr <- xxx_border_arrow_yyy_hux_brdr(
  "lr_borders",
  quote(seq_len(nrow(ht))), quote(-last_col)
)

right_border_set_default <- xxx_border_arrow_yyy_hux(
  "lr_borders",
  quote(seq_len(nrow(ht))), -1, "thickness"
)
right_border_set_brdr <- xxx_border_arrow_yyy_hux_brdr(
  "lr_borders",
  quote(seq_len(nrow(ht))), -1
)

top_border_set_default <- xxx_border_arrow_yyy_hux(
  "tb_borders",
  quote(-last_row), quote(seq_len(ncol(ht))), "thickness"
)
top_border_set_brdr <- xxx_border_arrow_yyy_hux_brdr(
  "tb_borders",
  quote(-last_row), quote(seq_len(ncol(ht)))
)

bottom_border_set_default <- xxx_border_arrow_yyy_hux(
  "tb_borders",
  -1, quote(seq_len(ncol(ht))), "thickness"
)
bottom_border_set_brdr <- xxx_border_arrow_yyy_hux_brdr(
  "tb_borders",

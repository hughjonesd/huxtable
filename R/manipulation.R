...
#'       after = 2)
#' insert_row(ht, 2.5, fill = 0, after = 2)
#'
#' insert_column(ht, 5:1)
#' insert_column(ht, 5:1, after = 3)
#' insert_column(ht, 5:1, after = "b")
insert_column <- function (ht, ..., after = 0, fill = NULL, copy_cell_props = TRUE) {
...
#'
#' @export
insert_row <- function (ht, ..., after = 0, fill = NULL, copy_cell_props = TRUE) {
  assert_that(
          is.scalar(after),
          is.number(after),
          after >= 0,

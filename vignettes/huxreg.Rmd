...
decimal places; if it is character, it will be taken as a format to the base R `sprintf` function;
if it is a function, the function will be called to format the number. `huxreg` tries to be smart

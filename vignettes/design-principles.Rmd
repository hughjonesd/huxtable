...
LaTeX and HTML tables. There still are, but in my opinion, the field of sensible modern choices
...
* `huxtable` has the widest range of outputs, and is very customizable. Its model
  is very much drawn from HTML, which can be tricky when outputting LaTeX. It aims
  to provide fine-grained control over formatting, at cell level wherever possible.

...
library(huxtable)
options(
# !CRAN        huxtable.latex_use_fontspec  = TRUE,
...
# !CRAN is_latex <- TRUE
# !CRAN knitr::knit_hooks$set(
# !CRAN   barrier = function(before, options, envir) {
# !CRAN     if (! before && is_latex) knitr::asis_output("\\FloatBarrier")
# !CRAN   }
# !CRAN )

# !CRAN if (is_latex) knitr::opts_chunk$set(barrier = TRUE)
...
# !CRAN mono_font <- if (is_latex) "LucidaConsole" else "monospace"

...
Sometimes you quickly want to get your data into a Word, Excel, Powerpoint, HTML or PDF document. To
do this you can use huxtable functions starting with `quick_`, shown below.

```{r, echo = FALSE}
quick_commands <- hux(
        Command = paste0("<code>", 
          c("quick_pdf", "quick_docx", "quick_html", "quick_xlsx", "quick_pptx"), 
          "</code>"),
...
the file will be in the current directory under the name e.g. `huxtable-output.pdf`. If the file

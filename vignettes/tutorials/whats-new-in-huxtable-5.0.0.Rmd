...
All the same, I reckon the [huxtable](https://hughjonesd.github.io/huxtable) package still has
something to offer. In particular, if you want to output to PDF 
(or Word, Powerpoint, Excel, RTF or Markdown), huxtable can do that.
...
[CTAN](https://ctan.org).
`huxtable::report_latex_dependencies()` will check this for you, and

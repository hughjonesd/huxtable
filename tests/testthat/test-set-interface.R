...
test_that("set_contents works", {
  ...
  expect_equivalent(set_contents(ht, 1:6), hux(1:3, 4:6, add_colnames = FALSE))
  expect_equivalent(set_contents(ht, 1, 1, 0), hux(c(0, 2:3), 1:3, add_colnames = FALSE))
  expect_equivalent(set_contents(ht, 1, 1, 0), hux(c(0, 2:3), 1:3, add_colnames = FALSE))
  expect_equivalent(set_contents(ht, 2:3, 2, 3:2), hux(1:3, c(1, 3, 2), add_colnames = FALSE))

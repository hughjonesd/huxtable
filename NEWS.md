...
* dplyr has moved to "Suggests:", lowering the dependency load considerably. dplyr verbs are still
  supported. huxtable gives a warning if dplyr is not installed.
